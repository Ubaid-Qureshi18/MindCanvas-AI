...
function getLocalDemoCanvas(prompt: string) {
  ...
  return {
    ...
    nodes: [
      ...
      { id: 'n7', type: 'competitor', title: 'Competitive Landscape', content: `Key Competitors: (1) Legacy Enterprise Tool ($200+/mo), (2) Niche Player ($49/mo), (3) DIY Spreadsheets. Our Advantage: 10x faster execution powered by AI workflows for "${p}".`, position: { x: 540, y: 560 }, width: 380, height: 280, metadata: {} },
