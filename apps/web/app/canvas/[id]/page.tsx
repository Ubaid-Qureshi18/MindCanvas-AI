  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', background: '#06060e' }}>
      ...
      <header style={{
        ...
        padding: '0 20px', zIndex: 10, flexShrink: 0,
...
function getLocalDemoCanvas(prompt: string) {
  ...
  return {
    canvas_title: title,
    nodes: [
      { id: 'n1', type: 'idea', title: '💡 Core Concept', content: `Project Idea: ${p}\n\nStrategic Vision: A state-of-the-art platform designed to transform "${p}" into a high-growth product. Focuses on frictionless onboarding, automated core workflows, and clear monetization.`, position: { x: 540, y: 220 }, width: 380, height: 240, metadata: {} },
      { id: 'n2', type: 'problem', title: '🎯 Problem Statement', content: problemText, position: { x: 60, y: 60 }, width: 380, height: 260, metadata: {} },
      { id: 'n3', type: 'solution', title: '✨ Unique Solution', content: solutionText, position: { x: 1020, y: 60 }, width: 380, height: 280, metadata: {} },
      { id: 'n4', type: 'target_users', title: '👥 Target Users (ICP)', content: `Primary ICP: Founders, product leads, and team managers aged 25-45 who require rapid execution and maximum productivity for "${p}".`, position: { x: 60, y: 380 }, width: 380, height: 260, metadata: {} },
      { id: 'n5', type: 'business_model', title: '💼 Business Model', content: `Tier 1 Starter: $29/mo (basic features).\nTier 2 Pro: $89/mo (advanced AI analysis, priority support).\nTier 3 Enterprise: $299/mo (SSO, custom API access).\nTarget LTV: $2,100+ with 6-month CAC payback.`, position: { x: 1020, y: 380 }, width: 380, height: 280, metadata: {} },
      { id: 'n6', type: 'market_research', title: '📈 Market Opportunity', content: `Market Sizing for "${p}":\n• TAM: $8.4B Global Market\n• SAM: $1.2B Addressable Segment\n• SOM: $15M Realistic Year 2 Capture\nGrowth Rate: 22% CAGR driven by AI automation adoption.`, position: { x: 540, y: 60 }, width: 380, height: 260, metadata: {} },
      { id: 'n7', type: 'competitor', title: '⚔️ Competitive Landscape', content: `Key Competitors: (1) Legacy Enterprise Tool ($200+/mo), (2) Niche Player ($49/mo), (3) DIY Spreadsheets. Our Advantage: 10x faster execution powered by AI workflows for "${p}".`, position: { x: 540, y: 560 }, width: 380, height: 280, metadata: {} },
      { id: 'n8', type: 'tech_stack', title: '🛠 Technical Architecture', content: `Frontend: Next.js 15, React 19, TypeScript, TailwindCSS.\nBackend: NestJS Node.js API, PostgreSQL (Supabase), Redis.\nInfrastructure: Vercel, Railway, Supabase Auth.`, position: { x: 60, y: 700 }, width: 380, height: 280, metadata: {} },
      { id: 'n9', type: 'roadmap', title: '🗺 90-Day Execution Roadmap', content: `Month 1: Core MVP launch for "${p}", payments, auth.\nMonth 2: User feedback loops, export tools, team seats.\nMonth 3: Public ProductHunt launch, SEO push, target $5,000 MRR.`, position: { x: 1020, y: 700 }, width: 380, height: 280, metadata: {} },
      { id: 'n10', type: 'marketing', title: '📣 Go-To-Market Strategy', content: `Channel 1: Founder-led LinkedIn/X build-in-public content.\nChannel 2: Cold outbound to 200 verified ICP leads per month.\nChannel 3: High-intent commercial SEO landing pages.`, position: { x: 60, y: 1020 }, width: 380, height: 280, metadata: {} },
      { id: 'n11', type: 'revenue', title: '💰 Revenue Projections', content: `Month 1: $580 MRR (20 users).\nMonth 3: $3,560 MRR.\nMonth 6: $14,200 MRR.\nMonth 12: $48,000 MRR. Break-even targeted at Month 5.`, position: { x: 1020, y: 1020 }, width: 380, height: 280, metadata: {} },
      { id: 'n12', type: 'risks', title: '⚠️ Key Risks & Mitigations', content: `1. User Friction (Prob: 35%, Impact: 8/10) -> 14-day free trial with hands-on onboarding.\n2. AI Accuracy (Prob: 20%, Impact: 7/10) -> Strict RAG context boundary.\n3. Competitors (Prob: 25%, Impact: 6/10) -> High shipping velocity.`, position: { x: 540, y: 1020 }, width: 380, height: 280, metadata: {} },
    ],
    connections: [
      { source: 'n1', target: 'n2' },
      { source: 'n1', target: 'n3' },
